        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">AhGoo</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                        ...
                        <div class="card h-lg-100">
                            ...
                            <div class="card-body d-flex justify-content-between align-items-start flex-column">
                                ...
                                <div class="d-flex flex-column my-7">
                                    <!--begin::Number-->
                                    <span class="fw-semibold fs-3x text-gray-800 lh-1 ls-n2">{{ $total_users }}</span>
                                    <!--end::Number-->
                                    <!--begin::Follower-->
                                    <div class="m-0">
                    ...
                    <div class="col-sm-6 col-xl-2 mb-xl-10">
                        ...
                        <div class="card h-lg-100">
                            ...
                            <div class="card-body d-flex justify-content-between align-items-start flex-column">
                                ...
                                <div class="d-flex flex-column my-7">
                                    <!--begin::Number-->
                                    <span class="fw-semibold fs-3x text-gray-800 lh-1 ls-n2">{{ $free_events }}</span>
                                    <!--end::Number-->
                                    <!--begin::Follower-->
                                    <div class="m-0">
                                        <span class="fw-semibold fs-6 text-gray-400">Free Events</span>
                                    </div>
                                    <!--end::Follower-->
                                </div>
                                <!--end::Section-->
                    ...
                    <div class="col-sm-6 col-xl-2 mb-xl-10">
                        ...
                        <div class="card h-lg-100">
                            ...
                            <div class="card-body d-flex justify-content-between align-items-start flex-column">
                                ...
                                <div class="d-flex flex-column my-7">
                                    <!--begin::Number-->
                                    <span class="fw-semibold fs-3x text-gray-800 lh-1 ls-n2">{{ $paid_events }}</span>
                                    <!--end::Number-->
                                    <!--begin::Follower-->
                                    <div class="m-0">
                                        <span class="fw-semibold fs-6 text-gray-400">Paid Events</span>
                                    </div>
                                    <!--end::Follower-->
                                </div>
                                <!--end::Section-->
                    ...
                    <div class="col-sm-6 col-xl-2 mb-xl-10">
                        ...
                        <div class="card h-lg-100">
                            ...
                            <div class="card-body d-flex justify-content-between align-items-start flex-column">
                                ...
                                <div class="d-flex flex-column my-7">
                                    <!--begin::Number-->
                                    <span class="fw-semibold fs-3x text-gray-800 lh-1 ls-n2">{{ $promotions }}</span>
                                    <!--end::Number-->
                                    <!--begin::Follower-->
                                    <div class="m-0">
                                        <span class="fw-semibold fs-6 text-gray-400">Promotions</span>
                                    </div>
                                    <!--end::Follower-->
                                </div>
                                <!--end::Section-->
                    ...
                    <div class="col-sm-6 col-xl-2 mb-5 mb-xl-10">
                        ...
                        <div class="card h-lg-100">
                            ...
                            <div class="card-body d-flex justify-content-between align-items-start flex-column">
                                ...
                                <div class="d-flex flex-column my-7">
                                    <!--begin::Number-->
                                    <span class="fw-semibold fs-3x text-gray-800 lh-1 ls-n2">{{ $posts }}</span>
                                    <!--end::Number-->
                                    <!--begin::Follower-->
                                    <div class="m-0">
                                        <span class="fw-semibold fs-6 text-gray-400">Posts</span>
                                    </div>
                                    <!--end::Follower-->
                                </div>
                                <!--end::Section-->
                    ...
                    <div class="col-sm-6 col-xl-2 mb-5 mb-xl-10">
                        ...
                        <div class="card h-lg-100">
                            ...
                            <div class="card-body d-flex justify-content-between align-items-start flex-column">
                                ...
                                <div class="d-flex flex-column my-7">
                                    <!--begin::Number-->
                                    <span class="fw-semibold fs-3x text-gray-800 lh-1 ls-n2">{{ $countries }}</span>
                                    <!--end::Number-->
                                    <!--begin::Follower-->
                                    <div class="m-0">
                                        <span class="fw-semibold fs-6 text-gray-400">Countries</span>
                                    </div>
                                    <!--end::Follower-->
                                </div>
                                <!--end::Section-->
