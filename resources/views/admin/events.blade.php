					...
					<div class="card-header border-0 pt-6">
						...
						<div class="card-title">
							...
							<div class="d-flex align-items-center position-relative my-1">
								...
								<!--end::Svg Icon-->
								<input type="text" data-kt-customer-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="Search Posts" />
							</div>
							<!--end::Search-->
						</div>
						<!--begin::Card title-->
						...
						<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
							...
							<thead>
								...
								<tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
									...
									<th class="min-w-125px">Total Invites</th>
								...
								<tr>
									...
									<td>
										<div class="form-check form-check-sm form-check-custom form-check-solid">
											<input class="form-check-input" type="checkbox" value="<?=$event->_id?>" />
										</div>
									</td>
									<td><img src="<?= !empty($event->cover_pic) ? $event->cover_pic : 'http://34.207.97.193/ahgoo/storage/profile_pics/video_thum.jpg' ?>" height="50" width="50"></td>
                                    <td><?= !empty($event->event_name) ? $event->event_name : 'N/A' ?></td>
                                    <td><?= !empty($event->event_date) ? $event->event_date : 'N/A' ?></td>
                                    <td><?= !empty($event->duration) ? $event->duration : 'N/A' ?></td>
                                    <td><?= !empty($event->location) ? $event->location : 'N/A' ?></td>
                                    <td><?= !empty($event->event_category) ? $event->event_category : 'N/A' ?></td>
                                    <td><?= !empty($event->event_created_by) ? $event->event_created_by : 'N/A' ?></td>
                                    <td><?= isset($event->event_invites_count) ? $event->event_invites_count : 'N/A' ?></td>
